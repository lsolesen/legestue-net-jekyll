var store = [{
        ...
        "title": "Hvem opfandt fodbold og hvornår? Fodboldens historie",
        "excerpt":"Hurtigt svar: Det moderne fodboldspil blev opfundet i England. Grundlaget for de regler, vi kender i dag, blev skabt i 1863, da det engelske fodboldforbund (The Football Association) blev stiftet med udgangspunkt i de såkaldte Cambridge-regler fra 1848. Fodbold er i dag verdens mest populære sportsgren, men spillets rødder strækker...","categories": ["Fodboldhistorie"],
        "tags": ["fodboldhistorie","hvem opfandt fodbold","hvornår blev fodbold opfundet","hvor stammer fodbold fra"],
        ...
        "title": "Hvor stor er en fodboldbane? Se mål og størrelser (11-, 8-, 5- & 3-mands)",
        "excerpt":"Hurtigt svar: En standard 11-mands fodboldbane er 105 meter lang og 68 meter bred, hvilket giver et samlet areal på 7.140 m². Størrelsen varierer dog afhængigt af, om der spilles 11-mands, 7/8-mands, 5-mands eller 3-mandsfodbold. De fleste har stået på banen og tænkt: Hvor stor er en fodboldbane egentlig? Begrebet...","categories": ["Viden om","Fodboldregler"],
        "tags": ["fodboldbane","fodboldbane størrelse","mål fodboldbane","fodboldregler"],
        ...
        "title": "Verdens største fodboldstadion: Top 10 liste",
        "excerpt":"Hurtigt svar: Verdens største fodboldstadion er Rungrado 1st of May Stadium i Pyongyang, Nordkorea, med en kapacitet på ca. 114.000 tilskuere. Europas største fodboldstadion er Camp Nou i Barcelona, Spanien. Elsker du atmosfæren på et fyldt stadion? Herunder får du den opdaterede liste over verdens største fodboldstadions målt på officiel...","categories": ["Fodboldhistorie"],
        "tags": ["fodboldstadions","verdens største fodboldstadion","største stadion i verden","største fodboldstadion i europa"],
        ...
        "title": "Hvor lang tid varer en halvleg i fodbold? (Se minutter & regler)",
        "excerpt":"Hurtigt svar: En standard halvleg i seniorfodbold (11-mands) varer 45 minutter. En hel fodboldkamp består af to halvlege og varer dermed 90 minutter plus tillægstid. Halvlegspausen mellem 1. og 2. halvleg er 15 minutter. Hvor lang tid en halvleg varer, afhænger dog i høj grad af aldersgruppe, antal spillere på...","categories": ["Viden om","Fodboldregler"],
        "tags": ["fodbold","halvleg i fodbold","hvor lang er en halvleg","spilletid fodbold"],
        "url": "/halvleg-fodbold/",
        ...
        "title": "Offside i fodbold: Reglerne forklaret simpelt (for dummies)",
        "excerpt":"Offside for dummies (Kort fortalt): Du er i offside, hvis du står foran forsvarsspillerne og tættere på modstanderens mål end bolden i det øjeblik, din medspiller afleverer til dig. Offside-reglen er en af fodboldens mest diskuterede regler, men den er egentlig ret simpel, når man først kender grundprincipperne. Herunder gennemgår...","categories": ["Fodboldregler"],
        "tags": ["fodbold","offside regler","hvad er offside","offside for dummies"],
        "url": "/offside-fodbold/",
        ...
        "title": "Hvad er Danmarks nationalsport? (Svaret er IKKE dart!)",
        "excerpt":"Hurtigt svar: Danmarks uofficielle nationalsport er fodbold. Danmark har ikke lovmæssigt vedtaget en officiel nationalsport, men fodbold er med sine mere end 350.000 aktive medlemmer, enorme tilskuertal og historiske forankring landets ubestridte nationalsport. Mange bliver dog overraskede, når de søger på Google efter “Danmarks nationalsport” og ser sporten dart dukke...","categories": ["Alt om fodbold"],
        "tags": ["fodbold","danmarks nationalsport","hvad er danmarks nationalsport","nationalsport i danmark"],
